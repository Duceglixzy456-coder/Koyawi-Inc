...
import SoldListingsScreen from "./SoldListingsScreen";
import ChatScreen from "./ChatScreen";
import SelectBuyerScreen from "./SelectBuyerScreen";
...
function AppStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="BoostListingDetail"
        component={BoostListingDetailScreen}
      />
